...
public class q3GUIMenuCommand implements CommandExecutor {
    ...
    public void openq3Menu(Player player) {
        ...
        gui.setItem(10, createGuiItem(Material.WHITE_CONCRETE, ChatColor.BLUE + "Infernal", 
            "Required level: 50", 
        ...
        gui.setItem(13, createGuiItem(Material.PRISMARINE_BRICKS, ChatColor.DARK_BLUE + "Hell", 
            "Required level: 65", 
        ...
        gui.setItem(16, createGuiItem(Material.GRAY_CONCRETE, ChatColor.GOLD + "Bloodshed", 
            "Required level: 80", 
