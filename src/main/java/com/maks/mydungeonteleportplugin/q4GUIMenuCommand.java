...
public class q4GUIMenuCommand implements CommandExecutor {
    ...
    public void openq4Menu(Player player) {
        ...
        gui.setItem(10, createGuiItem(Material.JUNGLE_LOG, ChatColor.BLUE + "Infernal", 
            "Required level: 50", 
        ...
        gui.setItem(13, createGuiItem(Material.HONEY_BLOCK, ChatColor.DARK_BLUE + "Hell", 
            "Required level: 65", 
        ...
        gui.setItem(16, createGuiItem(Material.GOLD_BLOCK, ChatColor.GOLD + "Bloodshed", 
            "Required level: 80", 
